...
- DONE [P0] [L] #6: Settlement arena scene — wasteland courtyard from `kenney/retro-urban-kit` + `survival-kit` + a few `city-kit-industrial` buildings — depends: #2 ✓ — scope: `src/scenes/Arena.ts`, `src/scenes/_dev/ArenaPreview.ts`
